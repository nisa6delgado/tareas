				...
				<div class="card text-justify">
					...
					<div id="<?php echo 'collapseThree_' . $task->id; ?>" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
						<div class="card-body">
							...
							<?php if ($task->files->count() && (strpos($task->description, '[') !== true or strpos($task->description, ']') !== true)): ?>
								<hr>
								<b>Archivos adjuntos</b>
								<br><br>
								<?php foreach ($task->files as $file): ?>
									<a title="Clic aquí para ver archivo" <?php lightbox($file->file, $task->title); ?> target="_blank" class="mr-3 attach <?php modal($file->file); ?>" href="<?php echo url('/resources/assets/files/' . $file->file . '?v=' . rand(9, 99999)); ?>">
