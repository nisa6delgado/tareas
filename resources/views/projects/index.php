						...
						<div class="card-body">
							...
							<?php if ($task->files->count() && (!strpos($task->description, '[') && !strpos($task->description, ']'))): ?>
								...
								<?php foreach ($task->files as $file): ?>
									<a title="Clic aquí para ver archivo" <?php lightbox($file->file, $task->title); ?> target="_blank" class="d-sm-block mr-3 attach <?php modal($file->file); ?>" href="<?php echo url('/resources/assets/files/' . $file->file . '?v=' . rand(9, 99999)); ?>">
