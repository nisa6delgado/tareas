...
trait HasRelationships
{
    ...
    public function belongsToMany($related, $table = null, $foreignKey = null, $relatedKey = null, $relation = null)
    {
        ...
        if (is_null($table)) {
            $table = $this->joiningTable($this->namespace . $related);
        }
    ...
    public function morphedByMany($related, $name, $table = null, $foreignKey = null, $relatedKey = null)
    {
        ...
        return $this->morphToMany($this->namespace . $related, $name, $table, $foreignKey, $relatedKey, true);
    }
    ...
    public function joiningTable($related)
    {
        ...
        $models = [
            Str::snake(class_basename($this->namespace . $related)),
